...
export const useGuestChatStore = defineStore('guestChat', () => {
  ...
  //     // إنشاء رسالة البوت الفارغة (يتم تحديثها لاحقاً)
  ...
  //       .filter(msg => msg.role !== 'assistant' || msg.content) // استبعاد الردود الفارغة
  //       .map(msg => ({
  //         role: msg.role,
  //         content: msg.content
  //       }))

  //     // إرسال الطلب إلى الـ API المحلي
  ...
  //     // تحديث الرد في الوقت الحقيقي (أو دفعة واحدة)
